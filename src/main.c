...
#include "../Hydrodrivers/hydrv_common.h"
#include "../Hydrodrivers/hydrv_clock.h"
#include "../Hydrodrivers/hydrv_gpio.h"
#include "../Hydrodrivers/hydrv_uart.h"
...
int main(void)
{
  ...
  // while (hydrv_UART_Transmit(USART3, byte) != HYDRV_OK)
  // {
  // }
  while (1)
  {
